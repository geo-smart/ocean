...
ranges = {
'conductivity':(0,100),'density':(0.5,1.5),'pressure':(0.,200.),'salinity':(31.5, 34.5),'temperature':(6.5, 11.),
...
colors = {
'conductivity':'black','density':'black','pressure':'black','salinity':'cyan','temperature':'red',
'chlora':'green','bb':'purple','fdom':'cyan',
'spkir':'black',
'nitrate':'black',
'pco2':'black',
'do':'blue',
